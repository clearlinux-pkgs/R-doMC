...
Version  : 1.3.7
Release  : 29
URL      : https://cran.r-project.org/src/contrib/doMC_1.3.7.tar.gz
Source0  : https://cran.r-project.org/src/contrib/doMC_1.3.7.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602777011
